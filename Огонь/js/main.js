...
var GameState = {
  ...
  update: function() {
	...
	if(this.cursors.up.isDown ){
	 ...
	 this.player.body.velocity.y += 10*this.SWIMMING_SPEED*Math.cos(this.player.body.rotation/57.2958)
	  this.player.body.velocity.x -= 10*this.SWIMMING_SPEED*Math.sin(this.player.body.rotation/57.2958)
	}
